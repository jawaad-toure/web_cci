...
class FormTest extends TestCase
{
    ...
    public function testCreateTeamRedirectsIfUserIsNotAuthenticated()
    {
    ...
    public function testStoreTeam()
    {
        ...
        $response = $this->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/teams', ['team_name' => 'Marseille']);
        $response->assertStatus(302);
        $response->assertRedirect('/teams/1');
    }

    public function testStoreTeamRedirectsIfUserIsNotAuthenticated()
    {
    ...
    {
        $response = $this->withHeader('Referer', '/teams/create')
    ...
    public function testStoreTeamRedirectsIfNameIsTooLong() 
    {
        $response = $this->withHeader('Referer', '/teams/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/teams', ['team_name' => 'AAAAAAAAAAAAAAAAAAAAA']);
        $response->assertStatus(302);
        $response->assertRedirect('/teams/create');
    ...
    public function testCreateMatchRedirectsIfUserIsNotAuthenticated()
    {
    ...
    public function testStoreMatch()
    {
        ...
        $response = $this->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0' => '1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/');
    }

    public function testStoreMatchRedirectsIfUserIsNotAuthenticated()
    {
    ...
    public function testStoreMatchRedirectsIfTeam0IsAbsent()
    {
        $this->repository->insertTeam(['name' => 'Marseille']);
        $this->repository->insertTeam(['name' => 'Paris']);
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
    ...
    public function testStoreMatchRedirectsIfTeam0DoesNotExist()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0' => '3', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfTeam1IsAbsent()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfTeam1DoesNotExist()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0' => '2', 'team1' => '3', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfDateIsAbsent()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfDateIsNotValid()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'aaa', 'time'=>'10:22', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfTimeIsAbsent()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfTimeIsNotValid()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'aaa', 'score0'=>'2', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore0IsAbsent()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore0IsNotInteger()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'a', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore0IsNegative()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'-1', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore0IsTooLarge()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'51', 'score1'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
        $response->assertSessionHasErrors(["score0"=>"Vous devez choisir un nombre de buts entre 0 et 50."]);
    }
    ...
    public function testStoreMatchRedirectsIfScore1IsAbsent()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'4']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore1IsNotInteger()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'4', 'score1'=>'a']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore1IsNegative()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])        
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'5', 'score1'=>'-1']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    ...
    public function testStoreMatchRedirectsIfScore1IsTooLarge()
    {
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'5', 'score1'=>'51']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
        $response->assertSessionHasErrors(["score1"=>"Vous devez choisir un nombre de buts entre 0 et 50."]);
    }
    ...
    {    
        ...
        $response = $this->withHeader('Referer', '/matches/create')
                         ->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
                         ->post('/matches', ['team0'=>'1', 'team1' => '2', 'date'=>'2048-10-05', 'time'=>'10:22', 'score0'=>'5', 'score1'=>'5']);
        $response->assertStatus(302);
        $response->assertRedirect('/matches/create');
    }
}